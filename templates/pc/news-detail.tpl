...
<div class="WebLP">
	 ...
	 viewBox="3880.2 3.9 8470.2 16170.4" enable-background="new 3880.2 3.9 8470.2 16170.4" xml:space="preserve">
<g id="Layer1">
	<path d="M4265.4,8474.1c-29.8-1.3-37.4-0.6-66.9-5.8c-44.1-7.8-86.8-23.3-125.7-45.7c-128.3-74-204-219.4-191.2-366.9
		c2.9-33.5,10.2-66.6,21.7-98.1c19.6-54,51-98.6,89.5-140.6c2179.2-2181,4358.6-4361.9,6538.9-6541.9
		c379.5-379.1,758.3-759.1,1139.3-1136.9l25.6-24.9c22.2-19.9,27.2-25.6,52-42.5c65-44.3,143.1-67.8,221.7-66.8
		c44.8,0.6,89.5,9,131.4,24.9c138.5,52.4,236.6,183.7,247.7,331.4c3.3,44.7-1.2,89.9-13.3,133c-15.2,53.9-42.3,104.4-78.8,146.8
		c-14.5,16.8-30.3,31.6-46.2,47.1c-775.2,768.7-1545.2,1542.8-2317.2,2314.7c-1785.6,1786.2-3571,3572.7-5356.2,5359.3l-24.8,22.7
		c-45.2,34.7-92.3,62.1-147.8,77c-28.9,7.8-36.5,7.8-66.1,11.7C4287.7,8473.1,4276.5,8473.6,4265.4,8474.1L4265.4,8474.1z"/>
	<path d="M11960.5,16174.3c-29.8-1.7-37.4-1.1-66.8-6.7c-55.1-10.4-107.7-33-153.2-65.7c-27.2-19.6-50.2-43.1-73.5-67
		c-768.7-775.2-1542.8-1545.2-2314.7-2317.2c-1786.2-1785.6-3572.7-3571-5359.3-5356.2l-22.7-24.8c-18.2-23.6-23.6-29.1-38.5-55
		c-22.4-38.8-38-81.5-45.8-125.6c-5.8-33.1-7.3-66.9-4.4-100.4c12.8-147.5,112.6-277.6,251.7-328.3c42.1-15.3,86.9-23.3,131.7-23.3
		c78.6,0,156.4,24.5,220.9,69.5c24.5,17.1,29.4,23,51.4,43.1c2181,2179.2,4361.9,4358.6,6541.9,6538.9
		c379.1,379.5,759.1,758.3,1136.9,1139.3l24.9,25.6c37.9,42.5,68.8,87.5,87.8,141.7c45,128.6,17.2,275-71.7,378.3
		c-21.9,25.5-47.2,48-75,67c-37,25.2-78.5,43.9-121.9,55c-29,7.4-36.6,7.3-66.2,10.8
		C11982.9,16173.6,11971.7,16173.9,11960.5,16174.3L11960.5,16174.3z"/>
</g>
</svg>
			</div>
			</div>
			<div class="LPContent">
					...
					<div class="ArticleMetadata">
						<div class="ArticleDate">{$contents.created_at|date_format:$dateFormat}</div>
...
</svg><span>Pick this article</span></div>
					<div class="PickCount"><span>{$contents.picks.length}</span></div>
				</div>
					<a class="TwitterShare button Other twitter-share-button" data-hashtags="playerapp" href="https://twitter.com/intent/tweet?button_hashtag=playerapp&text={$contents.title}&url=http://web.playerapp.tokyo/news.php?news_id={$contents.id}" target="_blank">
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 viewBox="0 0 274 223" enable-background="new 0 0 274 223" xml:space="preserve">
<g>
<defs>
	<rect id="SVGID_1_" x="0.1" y="0.8" width="273.3" height="222.1"/>
</defs>
<clipPath id="SVGID_2_">
	<use xlink:href="#SVGID_1_"  overflow="visible"/>
</clipPath>
<path clip-path="url(#SVGID_2_)" fill="#5FA9DD" d="M86,223c-31.7,0-61.2-9.3-86-25.2c4.4,0.5,8.9,0.8,13.4,0.8
	c26.3,0,50.5-9,69.7-24c-24.5-0.5-45.3-16.7-52.4-39c3.4,0.7,6.9,1,10.6,1c5.1,0,10.1-0.7,14.8-2c-25.7-5.2-45-27.8-45-55
	c0-0.2,0-0.5,0-0.7c7.6,4.2,16.2,6.7,25.4,7c-15-10.1-25-27.2-25-46.7c0-10.3,2.8-19.9,7.6-28.2C46.7,45,88,67.4,134.6,69.7
	c-1-4.1-1.5-8.4-1.5-12.8c0-31,25.1-56.1,56.1-56.1c16.1,0,30.7,6.8,40.9,17.7C243,16,255,11.4,265.8,4.9
	C261.6,18,252.8,29,241.2,36c11.3-1.4,22.2-4.4,32.2-8.8c-7.5,11.2-17,21.1-28,29c0.1,2.4,0.2,4.8,0.2,7.3
	C245.6,137.5,189.1,223,86,223"/>
</g>
</svg>
</a>
					<a class="FacebookShare button Other" target=”_blank” href="http://www.facebook.com/sharer/sharer.php?s=100&amp;p[url]=http://web.playerapp.tokyo/news.php?news_id={$contents.id};p[images][0]={$pick.user.profile_image_url}&amp;p[title]={$contents.title};p[summary]={$contents.title} | Player!”><img src=”http://logicum.co/wp-content/uploads/2013/01/facebookshare.jpg" data-hashtags="playerapp"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 viewBox="0 0 117.7 226.6" enable-background="new 0 0 117.7 226.6" xml:space="preserve">
...
C55.8,0,34.8,18.8,34.8,53.2v29.7H0v40.3h34.8v103.4H76.4z"/>
				...
				<div class="CommentThread" >
					{foreach from=$contents.picks item=pick}
						<div class="Comment" id="{$pick.id}">
							<div class="Picture" style="background-image: url({$pick.user.profile_image_url})"></div>
							<div class="TextContent">
								<div class="NameTitle">{$pick.user.full_name}</div>
								<div class="CommentDate">{$pick.created_at|date_format:$dateFormat}</div>
								<div class="CommentContent">{$pick.comment}</div>
							</div>
						</div>
					{/foreach}
				</div>
	 ...
	 viewBox="38.8 42.5 755.8 331.6" enable-background="new 38.8 42.5 755.8 331.6" xml:space="preserve">
<g>
	<g>
		<path d="M67.2,251l0,120.2l-28.5,3l0-252.4l49.2-5.2c15.9-1.7,28.4,1.7,37.6,10c9.2,8.3,13.8,20,13.8,35.1v31.3
			c0,20.7-7.4,34.5-21.4,43.4C107.6,243,91,248.5,67.2,251z M110.6,164.7c0-15.7-7.3-22.8-22-21.2l-21.4,2.2l0,78.1l22-2.3
			c14.2-1.5,21.4-10,21.4-25.5L110.6,164.7z"/>
		<path d="M152.4,362.6l0-252.1l28.5-3l0,225.2l65.3-6.8l-5.8,27.6L152.4,362.6z"/>
		<g>
			<path d="M362.2,340.3l-10.5-49.1l-56.7,5.9c-2.7,11-6.4,28.1-11.1,51.3l-28.5,3l55.4-257.9l28.5-3l51.4,246.7L362.2,340.3z
				 M324.5,160.8l-23.5,108.4l45.5-4.8C341.9,243.1,334.6,208.5,324.5,160.8z"/>
		</g>
		<g>
			<path d="M454.1,203.9l0,126.7l-31.6,3.3l0-126.7L375.8,86.7l30.3-3.2c4.1,11.1,14.7,38.5,31.6,82.2l29.7-88.6l30-3.1L454.1,203.9
				z"/>
		</g>
		<g>
			<path d="M513.1,324.8l0-252.7l92.9-9.7l0,26.9l-63.2,6.6l0,79.6l53-5.6v27.3l-53,5.6l0,92l63.2-6.6l0,26.9L513.1,324.8z"/>
		</g>
		<g>
			<path d="M704.8,182.1l37.3,118.7l-28.5,3L678.3,187l-19.5,2l0,120.2l-28.5,3l0-252.4l50.3-5.3c15.7-1.6,28.1,1.7,37.2,10
				c9.1,8.3,13.6,20,13.6,35.1v31.3C731.3,155.7,726.3,169.3,704.8,182.1z M681.2,81.3l-22.4,2.3l0,78.1l22.7-2.4
				c14-1.5,21.1-9.7,21.1-24.8l0-32.5C702.5,86.7,695.4,79.9,681.2,81.3z"/>
		</g>
		<g>
			<path d="M771.9,246.7L761.1,46l33.4-3.5l-10.7,203L771.9,246.7z M761.1,298.1l10.7-28.8l12-1.3l10.7,26.5L761.1,298.1z"/>
		</g>
	</g>
</g>
</svg>
						...
						<div class="TextLine">
							<h1>All your sports news in one place.</h1>
							<h3>Click here for more</h3>
							<p>Get updates on sports that
							intrests you. Connect with athelets
							and share your reactions.</p>
						</div>
						<div class="iPhone">
							<div class="iPhoneWrap">
								<img src="images/iPhone.png" alt="iPhone">
								<div class="screens">
									<img class="background"src="images/homescreen.PNG">
									<img class="timeline"src="images/timeline.PNG">
									<img class="article" src="images/article.PNG">
									<img class="category"src="images/category.PNG">
									<img class="ranking" src="images/ranking.png">
								</div>
							</div>
						</div>
						<div class="DownloadLink">
<a href="https://itunes.apple.com/jp/app/id897872395" alt="To the App Store"><svg version="1.1" id="US_UK_Download_on_the" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<g>
		...
		<g>
			...
			<path fill="#FFFFFF" d="M121.2,10.9c0,0.2,0,0.3,0,0.5H118c0,0.5,0.2,0.8,0.5,1.1c0.3,0.2,0.6,0.3,1,0.3c0.5,0,0.9-0.1,1.3-0.2
				...
				c-0.3,0-0.6,0.1-0.8,0.4c-0.2,0.2-0.3,0.5-0.3,0.8C118,10.6,120.2,10.6,120.2,10.6z"/>
					...
					<div class="CloseBigLP">Go back</div>
				</div>
			</div>
	...
	<div class="WebComponent">
		<iframe src="{$contents.url}"></iframe>
	</div>
</div>
